"""Recompute the canonical v0.24.2 connected-geometry SOC campaign."""
...
from gaussian_dynamics import run_v0242_release_benchmark
...
campaign_path = save_campaign_json(
    root / "results/v0242_pyscf_differential_soc_campaign.json",
    output,
)
evidence_path = save_campaign_json(
    root / "results/v0242_pyscf_differential_soc_evidence.json",
    output["pyscf_differential_soc_evidence"],
)
print("Saved campaign:", campaign_path)
print("Saved differential evidence:", evidence_path)
