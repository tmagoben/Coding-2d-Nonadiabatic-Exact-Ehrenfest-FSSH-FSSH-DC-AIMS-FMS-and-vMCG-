"""Recompute deterministic v0.25.3 controlled-basis evidence."""
...
from gaussian_dynamics import run_controlled_basis_validation_evidence_v253
...
print("Saved controlled-basis evidence:", path)
