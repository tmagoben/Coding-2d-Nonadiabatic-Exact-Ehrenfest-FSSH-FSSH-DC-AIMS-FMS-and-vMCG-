...
$$
|D_\mu\rangle=\partial_{\theta_\mu}|\Psi\rangle.
$$
...
$$
\frac{\partial r}{\partial\dot\theta_\mu}=i|D_\mu\rangle,
$$

stationarity gives

$$
0=2\operatorname{Re}\left\langle iD_\mu\middle|r\right\rangle.
$$
...
$$
\operatorname{Re}\langle iD_\mu|H|\Psi\rangle=\operatorname{Im}\langle D_\mu|H|\Psi\rangle.
$$
