# v0.15 PySCF Adaptive-Control Bridge

v0.15's complete TDSE defect is available because the analytic LVC benchmark can be
...
The Gaussian dynamics ledger in v0.15 is intentionally separate from those future
provider costs.
